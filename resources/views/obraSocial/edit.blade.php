                ...
                <div class="p-6 text-gray-900">
                  ...
                  <form action="{{ route('obraSocial.update', $medicalInsurence) }}" method="post">  
                    <div class="input-group mb-3">
                        ...
                        @method('PUT')
                          <div class="input-group mb-3">
                            <input type="text" value="{{ ucfirst($medicalInsurence->nombre_obraSocial) }}" name="nombre_obraSocial" id="nombre_obraSocial" required class="form-control rounded border-gray-300  shadow-sm focus:ring-indigo-500" placeholder="Nombre" aria-label="Nombre">
                          </div>
