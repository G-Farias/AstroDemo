                ...
                <div class="p-6 text-gray-900">
                  ...
                  <form action="{{ route('pacientes.store')}}" method="post">  
                    <div class="input-group mb-3">
                        ...
                        @foreach ($prePatient as $prepatient)
                           
                          <div class="input-group mb-3">
                            <input type="text" name="nombre" id="nombre" value="{{$prepatient->name}}" required class="form-control rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" placeholder="Nombre" aria-label="Nombre">
                            <input type="text" name="apellido" id="apellido" value="{{$prepatient->surname}}" required class="form-control rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" placeholder="Apellido" aria-label="Apellido">
                          </div>

                          <div class="input-group mb-3">
                            <input type="number" name="dni" id="dni" value="{{$prepatient->user}}" required class="form-control rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" placeholder="DNI" aria-label="Dni">
                          ...
                          <div class="input-group mb-3">
                          <input type="mail" name="email" id="email" value="{{$prepatient->email}}" class="form-control rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" placeholder="Email" aria-label="Email">
                          </div>
                          ...
                          <div class="input-group mb-3">
                            <select name="pais" id="pais"  class="form-control rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" required>
