                  ...
                  <form action="{{ route('pacientes.update', $patient) }}" method="post">  
                    <div class="input-group mb-3">
                        ...
                        @method('PUT')
                          ...
                          <div class="input-group mb-3">
                            <select name="pais" id="pais" value="{{ $patient->pais_residencia }}"  class="form-control rounded border-gray-300  shadow-sm focus:ring-indigo-500" required>
                            ...
                            <select name="provincia_residencia" id="provincia_residencia"  class="form-control rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" required> 
                              <option value="0" disabled selected>{{ $patient->provincia_residencia}}</option>
